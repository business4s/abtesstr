  ...
  val example = ABModelDTO(
    ...
    experiments = List(
      ...
      ABModelDTO.Experiment(
        ...
        end = Some(Instant.parse("2024-06-15T00:00:00Z")),
        bucketStart = 0,
      ...
      ABModelDTO.Experiment(
        ...
        start = Instant.parse("2024-06-16T00:00:00Z"),
      ...
      ABModelDTO.Experiment(
        ...
        start = Instant.parse("2024-06-21T00:00:00Z"),
        end = Some(Instant.parse("2024-07-10T00:00:00Z")),
        bucketStart = 1500,
        bucketEnd = 2500
      ),
      ABModelDTO.Experiment(
